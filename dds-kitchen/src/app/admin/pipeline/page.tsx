               ...
               <BentoCard key={'pay-'+order.id} className="min-w-[280px] snap-start p-5 bg-gradient-to-br from-teal-50 to-white border-teal-100 shadow-sm flex flex-col gap-4">
                 <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                       ...
                       <p className="text-lg font-black text-teal-700 tracking-tighter">{'â‚¹' + order.total_amount}</p>
                    </div>
                 </div>
                        ...
                        <div className="space-y-3 pt-2">
                           <div className="flex justify-between items-end">
                              <div>
                                 ...
                                 <p className="text-lg font-black text-gray-800 tracking-tighter tabular-nums">{'â‚¹' + order.total_amount}</p>
                              </div>
                              {order.delivery_code && (
